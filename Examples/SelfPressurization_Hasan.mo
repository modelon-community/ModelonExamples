...
model SelfPressurization_Hasan
    extends .VaporCycle.Experiments.HydrogenStorage.SelfPressurization_Hasan;
...
<p>Click on the following link to open this example documentation: <a href=\"modelica://VaporCycle.Experiments.HydrogenStorage.SelfPressurization_Hasan\">VaporCycle.Experiments.HydrogenStorage.SelfPressurization_Hasan</a></p> </html>", revisions="<html><!--COPYRIGHT--></html>"),
     experiment(
      StopTime=50400,
      Tolerance=1e-05,
